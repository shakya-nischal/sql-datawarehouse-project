...
BEGIN
    ...
    BEGIN TRY
        SET @batch_start_time = GETDATE();
            ...
            FROM '/var/opt/mssql/source/cust_info.csv'
            WITH (
                FIRSTROW = 2,
                FIELDTERMINATOR = ',',
                TABLOCK
            ...
            FROM '/var/opt/mssql/source/prd_info.csv'
            WITH (
                FIRSTROW = 2,
                FIELDTERMINATOR = ',',
                TABLOCK
            ...
            FROM '/var/opt/mssql/source/sales_details.csv'
            WITH (
                FIRSTROW = 2,
                FIELDTERMINATOR = ',',
                TABLOCK
            ...
            FROM '/var/opt/mssql/source/CUST_AZ12.csv'
            WITH (
                FIRSTROW = 2,
                FIELDTERMINATOR = ',',
                TABLOCK
            ...
            FROM '/var/opt/mssql/source/LOC_A101.csv'
            WITH (
                FIRSTROW = 2,
                FIELDTERMINATOR = ',',
                TABLOCK 
            ...
            FROM '/var/opt/mssql/source/PX_CAT_GIV2.csv'
            WITH (
                FIRSTROW = 2,
                FIELDTERMINATOR = ',',
                TABLOCK
            ...
            PRINT '================================';
            PRINT 'Data loading in Bronze layer completed successfully.';
